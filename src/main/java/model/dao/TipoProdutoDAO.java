...
public class TipoProdutoDAO {
    public void create(TipoProduto tp) {
        ...
        try {
              ...
              JOptionPane.showMessageDialog(null, "Falha ao cadastrar Tipo de Produto. Erro: " + ex.getErrorCode());
    ...
    public ArrayList<TipoProduto> read() {
        ...
        try{
            ...
            JOptionPane.showMessageDialog(null, "Falha ao consultar tipos de produto. Erro: ");
        }
        finally {
